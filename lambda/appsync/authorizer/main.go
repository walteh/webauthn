...
import (
	...
	"github.com/walteh/webauthn/pkg/secmgr"
	"github.com/walteh/webauthn/pkg/signinwithapple"
...
func main() {
	...
	abc := &Handler{
		...
		SecretsManager:  secmgr.NewClient(ctx, cfg, env.SignInWithApplePrivateKeyName()),
		Config:          cfg,
		counter:         0,
	}
