...
func (_m *MockProvider_storage) IncrementExistingCredential(ctx context.Context, crm types.CeremonyID, credid types.CredentialID) error {
	...
	if len(ret) == 0 {
		panic("no return value specified for IncrementExistingCredential")
	}
...
func (_m *MockProvider_storage) WriteNewCeremony(ctx context.Context, crm *types.Ceremony) error {
	...
	if len(ret) == 0 {
		panic("no return value specified for WriteNewCeremony")
	}
...
func (_m *MockProvider_storage) WriteNewCredential(ctx context.Context, crm types.CeremonyID, cred *types.Credential) error {
	...
	if len(ret) == 0 {
		panic("no return value specified for WriteNewCredential")
	}
