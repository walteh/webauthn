...
func TestJwtApple(t *testing.T) {
	...
	basicAppleClient := &AppleJwtClient{&url.URL{
		Scheme: "https",
	...
	tests := []struct {
		...
		{
			name: "A",
			client: &MockClient{keyfunc: func(t *jwt.Token) (interface{}, error) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			got, err := VerifyJwt(tt.args.ctx, tt.args.token, tt.client)
