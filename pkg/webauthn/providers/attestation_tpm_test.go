...
var testAttestationTPMResponses = []types.AttestationInput{
	...
	{
		CredentialID:       types.CredentialID(hex.MustBase64ToHash("hsS2ywFz_LWf9-lC35vC9uJTVD3ZCVdweZvESUbjXnQ")),
	...
	{
		CredentialID:       types.CredentialID(hex.MustBase64ToHash("UJDoUJoGiDQF_EEZ3G_z9Lfq16_KFaXtMTjwTUrrRlc")),
		CredentialType:     "public-key",
	...
	{
		CredentialID:       types.CredentialID(hex.MustBase64ToHash("h9XMhkVePN1Prq9Ks_VfwIsVZvt-jmSRTEnevTc-KB8")),
		CredentialType:     "public-key",
