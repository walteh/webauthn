...
var testAttestationTPMResponses = []string{
	...
	fmt.Sprintf(`{
		...
		"response": {
				"attestationObject": "%s",
				"clientDataJSON": "{\"type\":\"webauthn.create\",\"challenge\":\"uzn9u0Tx-LBdtGgERsbkHRBjiUt5i2rvm2BBTZrWqEo\",\"origin\":\"https://webauthn.io\",\"crossOrigin\":false}"
		}
    }`, hex.MustBase64ToHash("hsS2ywFz_LWf9-lC35vC9uJTVD3ZCVdweZvESUbjXnQ"),
		hex.MustBase64ToHash("hsS2ywFz_LWf9-lC35vC9uJTVD3ZCVdweZvESUbjXnQ"),
	...
	fmt.Sprintf(`{
		...
		"id": "%s",
		"response": {
			"clientDataJSON": "{\"origin\":\"https://localhost:44329\",\"challenge\":\"9JyUfJkg8PqoKZuD7FHzOE9dbyculC9urGTpGqBnEwnhKmni4rGRXxm3-ZBHK8x6riJQqIpC8qEa-T0qIFTKTQ\",\"type\":\"webauthn.create\"}",
			"attestationObject": "%s"
		},
		"type": "public-key"
		}`,
		hex.MustBase64ToHash("UJDoUJoGiDQF_EEZ3G_z9Lfq16_KFaXtMTjwTUrrRlc"),
		hex.MustBase64ToHash("UJDoUJoGiDQF_EEZ3G_z9Lfq16_KFaXtMTjwTUrrRlc"),
	...
	fmt.Sprintf(`{
		...
		"id": "%s",
		"response": {
			"clientDataJSON": "{\"origin\":\"https://localhost:44329\",\"challenge\":\"gHrAk4pNe2VlB0HLeKclI2P6QEa83PuGeijTHMtpbhY9KlybyhlwF_VzRe7yhabXagWuY6rkDWfvvhNqgh2o7A\",\"type\":\"webauthn.create\"}",
			"attestationObject": "%s"
		},
		"type": "public-key"
		}`,
		hex.MustBase64ToHash("h9XMhkVePN1Prq9Ks_VfwIsVZvt-jmSRTEnevTc-KB8"),
		hex.MustBase64ToHash("h9XMhkVePN1Prq9Ks_VfwIsVZvt-jmSRTEnevTc-KB8"),
