...
var safetyNetTestResponse = map[string]string{
	`success`: fmt.Sprintf(`{
		...
		"response":{
			"attestationObject":"%s",
			"clientDataJSON":"{\"type\":\"webauthn.create\",\"challenge\":\"dfo-HlqJp3MLK-J5TLxxmvXJieS3zGwdk9G9H9bPezg\",\"origin\":\"https:\\/\\/webauthn.io\",\"androidPackageName\":\"com.android.chrome\"}"
		}
	}`,
		(hex.MustBase64ToHash("AUiVU3Mk3uJomfHcJcu6ScwUHRysE2e6IgaTNAzQ34TP0OPifi2LgGD_5hzxRhOfQTB1fW6k63C8tk-MwywpNVI").Hex()),
		(hex.MustBase64ToHash("AUiVU3Mk3uJomfHcJcu6ScwUHRysE2e6IgaTNAzQ34TP0OPifi2LgGD_5hzxRhOfQTB1fW6k63C8tk-MwywpNVI").Hex()),
