...
var testAttestationResponses = []types.AttestationInput{
	{
		CredentialID:       hex.MustBase64ToHash("AOx6vFGGITtlwjhqFFvAkJmBzSzfwE1dBa1fVR_Ltq5L35FJRNdgkXe84v3-0TEVNCSp"),
	...
	{
		CredentialID:       hex.MustBase64ToHash("FOxcmsqPLNCHtyILvbNkrtHMdKAeqSJXYZDbeFd0kc5Enm8Kl6a0Jp0szgLilDw1S4CjZhe9Z2611EUGbjyEmg"),
		CredentialType:     "public-key",
	...
	{
		CredentialID:       hex.MustBase64ToHash("6Jry73M_WVWDoXLsGxRsBVVHpPWDpNy1ETGXUEvJLdTAn5Ew6nDGU6W8iO3ZkcLEqr-CBwvx0p2WAxzt8RiwQQ"),
		CredentialType:     "public-key",
...
var testAttestationOptions = []struct {
	...
	{
		challenge:        hex.MustBase64ToHash("rWiex8xDOPfiCgyFu4BLW6vVOmXKgPwHrlMCgEs9SBA="),
		relyingPartyId:   "localhost",
		relyingPartyName: "http://localhost:9005",
	},
	{
		challenge:        hex.MustBase64ToHash("+Ri5NZTzJ8b6mvW3TVScLotEoALfgBa2Bn4YSaIObHc="),
		relyingPartyId:   "webauthn.io",
		relyingPartyName: "https://webauthn.io",
	},

	{
		challenge:        hex.MustBase64ToHash("sVt4ScceMzqFSnfAq8hgLzblvo3fa4/aFVEcIESHIJ0="),
		relyingPartyId:   "webauthn.io",
		relyingPartyName: "https://webauthn.io",
	},
}
